    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('o_status', models.CharField(choices=[('Прийнято', 'accepted'), ('Оплачено', 'paid'), ('В обробці', 'in_processing'), ('Відправлено', 'shipped'), ('Доставлено', 'delivered'), ('Оплачено поставнику', 'paid_to_dropper')], default='Прийнято', max_length=45)),
