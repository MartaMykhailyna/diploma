# Generated by Django 5.0.1 on 2024-04-11 22:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Admins',
            fields=[
                ('id_admins', models.IntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Shoes',
            fields=[
                ('id_shoes', models.IntegerField(auto_created=True, default=1, editable=False, primary_key=True, serialize=False, unique=True)),
